...
namespace EnvironmentMonitor.Application.Interfaces
{
    ...
    {
        public Task AddMeasurements(SaveMeasurementsDto measurement, bool skipStatusCheck = false, bool skipVirtualSensorProcessing = false, bool skipDuplicates = false);
