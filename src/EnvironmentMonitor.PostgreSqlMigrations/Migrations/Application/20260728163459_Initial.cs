        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CreatedUtc = table.Column<DateTime>(type: "timestamp with time zone", nullable: true, defaultValueSql: "LOCALTIMESTAMP"),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ApiSecretId = table.Column<string>(type: "character varying(40)", maxLength: 40, nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ClaimType = table.Column<string>(type: "character varying(125)", maxLength: 125, nullable: true),
                    ClaimValue = table.Column<string>(type: "character varying(125)", maxLength: 125, nullable: true)
                },
                constraints: table =>
                {
