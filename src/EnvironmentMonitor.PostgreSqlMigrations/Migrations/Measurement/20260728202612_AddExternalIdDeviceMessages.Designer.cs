...
namespace EnvironmentMonitor.PostgreSqlMigrations.Migrations.Measurement
{
    ...
    [Migration("20260728202612_AddExternalIdDeviceMessages")]
    partial class AddExternalIdDeviceMessages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EnvironmentMonitor.Domain.Entities.DeviceMessage", b =>
                {
                    ...
                    b.HasIndex("Identifier", "DeviceId")
                        .IsUnique()
                        .HasFilter("\"Identifier\" IS NOT NULL AND \"IsDuplicate\" = FALSE");
            ...
            modelBuilder.Entity("EnvironmentMonitor.Domain.Entities.Measurement", b =>
                {
                    ...
                    NpgsqlIndexBuilderExtensions.IncludeProperties(b.HasIndex("SensorId", "Timestamp"), new[] { "Value", "TypeId", "TimestampUtc" });
            ...
            modelBuilder.Entity("EnvironmentMonitor.Domain.Entities.StatusVariable", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
